...
const me = {
  ...
  hasSiblings: true,
  shoeCount: 14,
  favThreeFoods: ['biscuits & gravy', 'sushi', 'donuts']
}; //end about me
console.log('A little about me:', me); //log to test object
...
console.log(me.shoeCount); //new shoe count with new pair that Dane bought for me!!
